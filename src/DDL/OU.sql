...
/****** Object:  View [dbo].[vw_OrgaoUnidade]    Script Date: 25/06/2018 18:32:16 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "vw_DS01_OUCompleto_MDM (GLOBAL.OU)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 313
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_OrgaoUnidade'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_OrgaoUnidade'
GO
